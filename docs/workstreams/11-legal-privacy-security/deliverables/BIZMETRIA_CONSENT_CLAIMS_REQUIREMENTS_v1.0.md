...
- **Task:** LS-002 — Consent, Claims, and Data Requirements.
- **Status:** REVIEW on `task/ws-11/LS-002-consent-claims-data-requirements`; draft PR pending creation.
...
- **Validation performed:** Surface/data-class/field coverage, 44-field count, consent-state separation, claims review, privacy-rights and retention fail-closed review, official-source recheck, bilingual semantic parity review, Stripe secret/live-boundary review, link and Markdown checks pending final branch validation.
