# Free Audit and Lead Scoring Deliverables

This directory stores substantive, versioned outputs produced by Workstream 04. Operating files remain one directory above.

## Naming convention

Use descriptive uppercase names with a semantic or numbered version when appropriate, for example:

`FA_DESCRIPTIVE_DELIVERABLE_v0.1.md`
