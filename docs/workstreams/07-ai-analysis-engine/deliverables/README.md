# AI Analysis Engine Deliverables

This directory stores substantive, versioned outputs produced by Workstream 07. Operating files remain one directory above.

## Naming convention

Use descriptive uppercase names with a semantic or numbered version when appropriate, for example:

`AE_DESCRIPTIVE_DELIVERABLE_v0.1.md`
