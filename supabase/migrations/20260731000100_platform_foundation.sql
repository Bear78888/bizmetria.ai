...
create unique index consents_active_subject_channel_unique
  on public.consents (
...
create table public.free_assessment_answers (
  id uuid primary key default extensions.gen_random_uuid(),
...
create table public.paid_assessments (
  id uuid primary key default extensions.gen_random_uuid(),
...
create index leads_owner_profile_idx on public.leads (owner_profile_id);
create index leads_business_idx on public.leads (business_id);
...
create index free_assessments_lead_idx on public.free_assessments (lead_id);
create index free_assessments_owner_idx on public.free_assessments (owner_profile_id);
create index free_assessment_answers_assessment_idx
...
create index paid_assessments_customer_idx on public.paid_assessments (customer_profile_id);
create index paid_assessments_status_idx on public.paid_assessments (status);
create index interview_sessions_assessment_idx
  on public.interview_sessions (paid_assessment_id);
create index call_records_interview_idx on public.call_records (interview_session_id);
create index analysis_runs_assessment_idx on public.analysis_runs (paid_assessment_id);
create index analysis_runs_status_idx on public.analysis_runs (status);
create index recommendations_analysis_idx on public.recommendations (analysis_run_id);
create index reports_assessment_idx on public.reports (paid_assessment_id);
create index reports_status_idx on public.reports (status) where deleted_at is null;
create index report_reviews_report_idx on public.report_reviews (report_id);
create index consultations_assessment_idx on public.consultations (paid_assessment_id);
create index email_events_lead_idx on public.email_events (lead_id);
create index email_events_profile_idx on public.email_events (recipient_profile_id);
